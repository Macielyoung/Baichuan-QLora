...
def main(
    ...
    assert (
        base_model
    ), "Please specify a --base_model, e.g. --base_model='Baichuan-7B'"
    ...
    gr.Interface(
        ...
        inputs=[
            ...
            #     lines=2,
            #     label="Instruction",
            #     placeholder="Tell me about your instruction.",
            # ),
            ...
            gr.components.Slider(
                minimum=0.1, maximum=1.2, value=1.2, label="Repetition penalty"
            ),
        ...
        title="Baichuan-QLoRA",
        description="Baichuan-QLoRA is a 7B-parameter Baichuan model finetuned to follow instructions. It is trained on the some Chinese and English instruction datasets and makes use of the Huggingface Baichuan implementation.",  # noqa: E501
